...
class ConvertNumeroTexto
{
    ...
    public static function calculaJuros($dataVencimento, $valorParcela)
    {
        ...
        $multa = $valorParcela * (15 / 100);
        $juros = 0.33 * $dias;
        $parcelaJuros = $multa + $valorParcela;

        $parcelaJuros = $parcelaJuros + ($parcelaJuros * ($juros / 100));

        return number_format($parcelaJuros, '2');
    }
