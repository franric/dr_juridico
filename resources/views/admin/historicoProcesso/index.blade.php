            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <div class="box-header with-border">
                        <a class="btn btn-primary btn-flat pull-right" href="{{ route('historicoProcesso.create') }}"><i
        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><i class="fa fa-user"></i> Lista de Historico do Processo</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $historico->Contrato->numContrato }}</td>
                                <td>
                                    @foreach ($historico->Contrato->Pessoa as $pessoa)
...
<script>
    ...
    function getDelete(historico) {

        $('#modal-success').modal('show');
        $('#nome').html(historico.pessoa.nomeRazaoSocial);
        $('#cpfCnpj').html(historico.pessoa.cpfCnpj);
    ...
    function Delete() {
        ...
        $.ajax({
            type: 'get',
            url: '/procuracao/excluir/' + idhistorico,
            success: function (data) {
                console.log(data['success']);
                if (data['success']) {
                    $('#modal-success').modal('hide');
                    window.location.replace('/historicoProcesso');
                } else {
                    $('#modal-success').modal('hide');
