        ...
        <div class="modal-dialog" style="width: 600px">
            <div class="modal-content">
                <div class="modal-header-delete">
                    <h3><i class="fa fa-trash-o"></i> Excluir Forma de Pagamento</h3>
                </div>
                ...
                <div class="modal-footer">
                    {!! Form::open(['route' => ['formaPagamento.destroy', $formaPagamento->id], 'method' => 'DELETE']) !!}
                    {!! Form::submit('Excluir', ['class' => 'btn flat btn-primary']) !!}
                    <a href="{{ route('formaPagamento.index') }}" class="btn btn-primary flat">Voltar</a>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
