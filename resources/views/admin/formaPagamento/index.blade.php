      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            href="{{ route('formaPagamento.create') }}"><i class="fa fa-plus"></i> Cadastrar</a>
            </div>
      ...
      <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title"><i class="fa fa-dollar-sign"></i> Fromas de Pagamentos</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <div style="margin-right:5px" class="btn-group">
                                            <a href="{{ route('formaPagamento.edit', $formaPagamento->id) }}"
                                               data-toggle="tooltip" data-placement="top"
                                               title="Editar Registro"><i class='fa fa-pencil-alt text-primary'></i>
                                            </a>
                                        </div>
                                        <div style="margin-right:5px" class="btn-group">
                                            <a href="{{ route('formaPagamento.show', $formaPagamento->id) }}"
                                               data-toggle="tooltip" data-placement="top"
