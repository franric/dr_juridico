    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('home') }}" class="brand-link">
          <img src="{{ asset('imagens/logo_dr.jpg') }}" alt="Logo" class="brand-image img-size-50 img-circle elevation-3" style="opacity: .8;>
          <span class="brand-text font-weight-light">DR-Jur</span>
        </a>
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <!-- <img src="{{ asset('imagens/logo_dr.png') }}" class="img-circle elevation-2" alt="User Image"> -->
            </div>
            <div class="info">
